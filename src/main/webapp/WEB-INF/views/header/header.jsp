    ...
    <div class="container px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                <li class="nav-item"><a class="nav-link active" aria-current="page" href="/notice_board/list">Notice</a></li>
                ...
                <c:when test="${isLogin == 'true'}">
                    <form action="/logout" mehtod="post" class="d-flex">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                            ...
                            <li class="nav-item"><a href="/payment/charge"><span class="badge bg-dark text-white ms-1 rounded-pill"><fmt:formatNumber value="${user.cash}"/> KRW</span></a></li>
